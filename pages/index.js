  ...
  return (
    <div className="w-full min-h-screen bg-black text-white">
      <div
        ...
        style={{
          backgroundImage: "url('/Redline_Recovery_Hero_Banner_3Lines_Centered.jpg')",
        }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-center px-4">
          ...
          <p className="max-w-2xl text-sm md:text-lg mb-6">
            This isn’t theory. It’s the road I’ve walked. Redline Recovery is for the injured, the
            burnt out, the ones who feel like they’re losing everything. Let’s rebuild — together.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="bg-gray-100 p-6 rounded-xl shadow">
            <h3 className="font-semibold text-lg mb-2">
              I’m Injured and Don’t Know What to Do Next
            </h3>
      ...
      <div className="bg-gray-50 text-black py-16 px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-md mb-8">
          Whether you're injured, burned out, or barely holding on — you're not alone. Redline
          Recovery exists to give you tools, support, and connection to start rebuilding. Pick where
          you are right now.
        </p>
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
